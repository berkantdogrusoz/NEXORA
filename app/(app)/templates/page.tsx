...
const MOTION_TEMPLATES: TemplateCard[] = [
  {
    id: "drunk-dance",
    name: "Drunk Dance",
    description: "Viral, playful dance choreography with controlled body motion.",
  ...
  },
  {
    id: "hero-fly",
    name: "Hero Fly",
    description: "Cinematic rise, takeoff, and forward flight motion.",
  ...
  },
  {
    id: "escape-run",
    name: "Escape Run",
    description: "Fast-paced escape run action sequence.",
  ...
  },
  {
    id: "power-pose",
    name: "Power Pose",
    description: "Charismatic walk-in and strong final hero pose.",
  ...
  },
  {
    id: "street-groove",
    name: "Street Groove",
    description: "Street groove dance sequence synced to the beat.",
  ...
  },
  {
    id: "anime-burst",
    name: "Anime Burst",
    description: "Anime-inspired fast dash and action pose finale.",
      ...
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8 pt-10 md:pt-16">
        <div className="mb-8">
          ...
          <p className="text-white/60 mt-2 text-sm md:text-base">
            Pick a motion template, upload one photo, and generate your video in one click. Auto model: <span className="text-cyan-400 font-semibold">Kling 3.0</span>
          </p>
        </div>

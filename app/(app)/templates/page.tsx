...
const MOTION_TEMPLATES: TemplateCard[] = [
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start with feet shoulder-width apart, both fists pulled to chest, then punch right arm diagonally down-left while left arm hooks behind the head on the first beat.",
      "Snap into a double arm wave — right arm extends out, rolls through the shoulder, transfers to left arm extending out — fluid like a ripple, torso leaning slightly with each wave.",
      "Hit a sharp body roll from chest down through hips, knees bending on the drop, then immediately pop back up with both arms crossed at the wrists in front of the face.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start with a deep bounce, knees bent, shoulders loose, head nodding to the beat — then hit a sharp chest pop that ripples through the shoulders, arms hanging heavy at the sides.",
      "Right arm shoots up in a flex pose while left arm drops to the side, then reverse — left arm flexes up, right drops — alternating with each beat hit, shoulders isolating hard.",
      "Drop into a wide stance, roll the neck slow and controlled from left to right, then snap into a double arm thrust forward like pushing an invisible wall — elbows locked, fingers spread.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start in a slight side stance, chin down with a fierce gaze — on the beat drop, snap the right hand to point directly at camera while left hand rests on the waist, weight shifting to the right hip.",
      "Pull the pointing hand back to brush through hair in a dramatic hair flip motion, head tilting back, then snap both hands to frame the face — palms open beside both cheeks, fingers together, idol-pose style.",
      "Step-touch to the right with a sharp hip pop, then step-touch to the left with another hip pop — arms doing a synchronized wave from right to left at shoulder height, wrists flicking at each endpoint.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start with a relaxed stance, weight on the back foot — initiate a slow, deep body roll starting from the chest rolling forward, through the stomach, pushing the hips back, then snapping upright — smooth and fluid like a wave passing through the torso.",
      "Transition into a waist wine: hands resting lightly on the thighs, hips drawing a wide horizontal circle — clockwise for two rotations, keeping the upper body stable and shoulders relaxed, knees softly bent throughout.",
      "Add a shoulder shimmy — rapid alternating shoulder forward-back vibrations for four beats while the feet do a subtle toe-heel rock, head gently bobbing, a playful smirk on the face.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start with the Running Man: right foot stomps forward flat while left foot slides backward on the ball — then switch, left foot stomps forward, right slides back — repeat four times with increasing speed, arms pumping naturally at the sides.",
      "Transition into the T-Step: pivot on the right heel while the left foot taps out to the side, then pivot left heel while right foot taps out — creating a rapid side-to-side sliding motion, feet barely leaving the ground, arms loose and flowing.",
      "Hit a quick 360-degree spin on the ball of the right foot, arms tucked close to the body for speed, then land right back into the Running Man without missing a beat — seamless transition.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start with salsa basic step: step forward with the right foot on beat 1, weight transfers back to left foot on beat 2, right foot returns on beat 3 — hips swaying naturally with each weight change, arms bent at 90 degrees with soft fists.",
      "Add Cuban hip motion: exaggerate the hip action — as the right foot steps, the right hip pushes out sharply, then the left hip on the return — upper body stays tall and proud, chest lifted, shoulders back.",
      "Perform a cross-body lead styling: step across the body to the left with the right foot, sweep the right arm overhead in a dramatic arc, then unwind with a smooth half-turn, hair and clothes following the rotation momentum.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start with a dramatic runway walk forward — three steps with exaggerated hip sway, chin up, fierce gaze, one hand on the hip, the other arm swinging with attitude — each step landing heel-first with confidence.",
      "Stop and hit a hand performance sequence: both arms extend forward, wrists rotating in circles, then snap into geometric angles — right arm straight up, left arm bent at 90 degrees, switch instantly — sharp angular poses like a living fashion photograph.",
      "Transition into a duckwalk: drop into a deep squat, knees out to the sides, and waddle-step forward two steps while keeping the upper body perfectly upright and arms framing the face in a glamorous pose.",
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "Start bouncing with loose knees and shoulders rolling — on the drop, hit THE WOAH: right arm swings from left to right in a smooth arc and freezes mid-air at the right side, palm down, while the body leans slightly in the opposite direction, everything stops for one beat.",
      "Snap out of the freeze into HIT THE QUAN: squat down low, both fists pull to the right hip, then thrust them diagonally up-left with a head snap — bounce twice in the squat, fists pumping on each bounce.",
      "Rise up into a clean DAB: right arm extends straight forward while left arm tucks into the right elbow pit, face buried in the left elbow — hold for one beat, then reverse-dab to the other side without pausing.",

...
const MOTION_TEMPLATES: TemplateCard[] = [
  ...
  },
  {
    ...
    audioVolume: 0.8,
    motionSequence: [
      "[Seconds 0–2] Standing upright on two legs, bounce deep with knees bending low and popping back up four times. On the fourth bounce, the chest thrusts forward hard making the shoulders and head jolt — arms swing heavy at the sides like weighted pendulums. The bounce is big and visible, whole body goes up and down.",
      "[Seconds 2–3.5] Right arm shoots straight up into a strong flex pose, bicep tight, left arm hangs down. Hold half a beat. Then switch instantly — left arm flexes up, right drops. Switch four times total, each switch faster than the last. The shoulders pop sharply on every switch, head snaps to face the raised arm each time.",
      "[Seconds 3.5–5] Feet stomp into a wide stance. The neck rolls slowly in a full circle — left, back, right, forward — with attitude. Then both arms thrust straight forward at full extension, palms open, pushing an invisible wall. The whole torso leans into the push, then snaps back upright. Repeat the push-and-snap twice.",
      "[Seconds 5–6.5] Both arms pull tight into an X across the chest. Hold one beat. Then burst them open into a full T-pose — arms stretched to maximum wingspan, fingers spread wide. Right foot stomps the ground hard on the opening. Head snaps sharply to the right. Then pull back to X and burst open again to the left side with a left foot stomp.",
      "[Seconds 6.5–8] Both fists pull up to chin level, drop into a deep squat bouncing twice with rhythm — the whole body compresses down and springs up on each bounce. Then rise up tall and strong with one fist punching straight up overhead. Hold this victory pose completely frozen — zero movement, full confidence, for the remaining time.",
    ],
